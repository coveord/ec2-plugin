...
public class ConfigurationAsCodeTest {
    ...
    public void testConfigAsCodeExport() throws Exception {
        ...
        // Retro-compatibility with old instance type
        expected = expected.replace("type: T2Micro", "type: \"t2.micro\"");
    ...
    public void testMacCloudConfigAsCodeExport() throws Exception {
        ...
        // Retro-compatibility with old instance type
        expected = expected.replace("type: Mac1Metal", "type: \"mac1.metal\"");
        assertEquals(expected, exported);
    }
}
